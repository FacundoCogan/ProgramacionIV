...
public void eliminarPublicacionesExpiradas()
	{
		Scanner e = this.obtenerEntrada();
		String rta = "";
		System.out.print("\nEsta seguro que desea eliminar todas las publicaciones expiradas?(S/N): ");
		rta = e.next();
...
{
	System.out.println("Las publicaciones contratadas son: ");
	for(Publicacion publi: publicaciones)
		{
			publi.informarContratados();	
		}
}
